...
/**
 * The Taiwan scene, back to front: photos of Taiwan in rotation, a light shade at the top and
 * on the left for the headings and the wheel, Pelosi and Buffett, the government jet flying in
 * now and then, and the news crawl at the bottom. Without the photos the page stays a deep
 * lacquer-black with the same layers on top.
 */
