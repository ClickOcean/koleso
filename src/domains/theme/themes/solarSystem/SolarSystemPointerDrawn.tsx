 ...
 * body drifts a little, like it is coasting past. Запасной вариант стрелки: показывается, пока
 * фотоспрайт `pointer.png` не загрузился или файла нет (см. `SolarSystemPointer`).
 */
const SolarSystemPointerDrawn = ({ layout }: PointerProps) => {
...
export default SolarSystemPointerDrawn;
